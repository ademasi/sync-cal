...
var isOwnCalendar = function(calendar, extension) {
  return calendar.superCalendar.type == "ext-" + extension.id;
};

var unwrapCalendar = function(calendar) {
...
var getResolvedCalendarById = function(extension, id) {
  let calendar;
...
var getCachedCalendar = function(calendar) {
  return calendar.wrappedJSObject.mCachedCalendar || calendar;
};

var isCachedCalendar = function(id) {
  return id.endsWith("#cache");
};

var convertCalendar = function(extension, calendar) {
  if (!calendar) {
    return null;
  }
...
var propsToItem = function(props) {
  let jcalComp;
...
var convertItem = function(item, options, extension) {
  if (!item) {
    return null;
  }
...
var convertAlarm = function(item, alarm) {
...
var setupE10sBrowser = async function(extension, browser, parent, initOptions={}) {
